 ...
 * @author ROLANDO
 */
@WebServlet(name = "LlamaProcesa", urlPatterns = {"/LlamaProcesa"})
public class LlamaProcesa extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           out.println("<html>");
            ...
            //out.println(submit);   
            String a = consultaBase(submit);
            String b = procesaInformacion(a);

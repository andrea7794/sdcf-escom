<%-- 
    Document   : f_cp
    Created on : May 28, 2012, 2:24:46 PM
    Author     : ROLANDO
--%>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td colspan="2" rowspan="3" align="center" valign="top"><p>
                            <h2><strong> FINANCIAMIENTO A CORTO PLAZO</strong></h2>
                            <p>ACEPTACIONES BANCARIAS</p>
                            <h2>&nbsp;</h2>
                            <h3> -Cuando un exportador da crédito  a un comprador extranjero emitiendo un giro para alguna fecha en el futuro.</h3>
                            <h3>-La aceptación bancaria, puede ser vendida en el mercado de dinero. </h3>
                            <h3>-Se vende con un descuento relacionado con el riesgo del banco aceptante <a href="qys.jsp"><img src="../images/qys.png" width="265" height="143" /></a></h3></td>
                ...
                <tr>
                    <td colspan="2" rowspan="2" align="left"><h6>&nbsp;</h6>        <h6>&nbsp;</h6>        <h6>&nbsp;</h6>        <h6>&nbsp;</h6>        <h6>&nbsp;</h6>          </td>
                </tr>
                <tr>
                    <td align="center"><p>&nbsp;</p>
                        <p>&nbsp;</p>

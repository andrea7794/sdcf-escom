<%-- 
    Document   : graciasqys
    Created on : May 28, 2012, 2:25:46 PM
    Author     : ROLANDO
--%>
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="2"><h6>&nbsp;</h6>
                        ...
                        <p>&nbsp;</p>
                        <p>&nbsp;</p></td>
                    <td colspan="2" rowspan="2" align="center" valign="top"><h2>&nbsp;</h2>
                        <h2>TU QUEJA Y/O SUGERENCIA FUE ENVIADA CON EXITO,</h2>
                        <h2>&nbsp;</h2>
                        <h2>NOS COMUNICAREMOS CONTIGO A LA BREVEDAD POSIBLE.</h2>
                        <h2>&nbsp;</h2>
                        <h2>GRACIAS!!..</h2>
                        <p>&nbsp;</p></td>
                    <td width="290" align="right"><h5><strong><a href="carta.jsp">&lt;--</a>¿QUE ES UNA CARTA DE CREDITO?</strong></h5>

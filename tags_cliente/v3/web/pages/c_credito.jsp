<%-- 
    Document   : c_credito
    Created on : May 28, 2012, 2:13:33 PM
    Author     : ROLANDO
--%>
        ...
        <table width="1321" height="1015" border="0" align="center">
            <tbody>
                ...
                <tr>
                    ...
                    <td colspan="3"><p>&nbsp;</p>
                        <p><a href="compromisocial.jsp"><img src="../images/images/compromiso_social.png" width="346" height="149" align="right" /></a></p></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="2" rowspan="3" align="center" valign="top"><p>
                            <h2><strong> </strong>CARTA DE CRÉDITO DE IMPORTACIÓN</h2>
                            <p>&nbsp;</p>
                            <h3>Es un compromiso de pago, aceptación o negociación que asume un Banco (Banco emisor) a favor de un tercero (beneficiario). </h3>
                            <h3>El Banco actúa a solicitud y con instrucciones de un cliente (ordenante), utilizando los servicios de un Banco Corresponsal en el exterior (avisador o confirmador).</h3></td>

...
public class Consulta extends HttpServlet {
    ...
    private static String consulta3Meses(java.lang.String dep) {
    ...
    private static String consulta1Mes(java.lang.String dep) {
        escom.tds.servidor.Prevencion_Service service = new escom.tds.servidor.Prevencion_Service();
        escom.tds.servidor.Prevencion port = service.getPrevencionPort();
        return port.consulta1Mes(dep);
    }

    private static String consulta1Ano(java.lang.String dep) {
        escom.tds.servidor.Prevencion_Service service = new escom.tds.servidor.Prevencion_Service();
        escom.tds.servidor.Prevencion port = service.getPrevencionPort();

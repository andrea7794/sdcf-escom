<%-- 
    Document   : c_domestica
    Created on : May 28, 2012, 2:14:40 PM
    Author     : ROLANDO
--%>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td colspan="2" rowspan="3" align="center" valign="top"><p>
                            <h2><strong> </strong>CARTAS DE CRÉDITO DOMESTICAS</h2>
                            <p>&nbsp;</p>
                            <h3>Es un instrumento o modalidad de pago para atender una obligación producto de una transacción comercial dentro del territorio nacional, siendo éste un compromiso asumido por un Banco, actuando por cuenta del Comprador, de pagar al beneficiario el importe indicado en los instrumentos de giro y/o documentos siempre y cuando se cumplan los términos y condiciones del crédito. </h3></td>

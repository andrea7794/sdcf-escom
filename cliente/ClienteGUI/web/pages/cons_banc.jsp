<%-- 
    Document   : cons_banc
    Created on : May 28, 2012, 2:22:21 PM
    Author     : ROLANDO
--%>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td colspan="2" rowspan="3" align="center" valign="top"><p>
                            <h2><strong> SUCURSALES EXTRANJERAS</strong></h2>
                            <p>&nbsp;</p>
                            <h2>&nbsp;</h2>
                            <h3>-Son bancos operativos idénticos a los locales, excepto que los directores y los propietarios tienden a residir en otras partes. </h3>
                            <h3>-Se rigen bajo las reglas locales, pero también bajo las reglas del país de origen. </h3>
                            <h3>-Los libros se incorporan a los de la casa matriz, aunque mantiene libros individuales para revelar su desempeño, propósitos fiscales. </h3></td>

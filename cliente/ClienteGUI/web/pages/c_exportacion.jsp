<%-- 
    Document   : c_exportacion
    Created on : May 28, 2012, 2:15:18 PM
    Author     : ROLANDO
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body text="#660099" vlink="#FFFFFF" alink="#FFFFFF">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td colspan="2" rowspan="3" align="center" valign="top"><p>      
                            <p>
                                <h2><strong> </strong>CARTAS DE CRÉDITO DE EXPORTACIÓN</h2>
                                <p>&nbsp;</p>
                                <h3>Es un instrumento que le sirve a su empresa para recibir el pago del comprador en el exterior por concepto de exportación de mercancías, previo cumplimiento de los requisitos establecidos en el crédito y pactados entre comprador y vendedor. </h3></td>
                                ...
                                <tr>
                                    <td align="center"><p>&nbsp;</p>
                                        ...
                                        <p><strong><a href="www.facebook.com">Banco.Multinacional@facebook.com</a></strong></p>
                                        <p><strong><a href="www.twitter.com"><img src="../images/icon-twitter.jpg" width="45" height="44" alt="TWITTER" /></a> </strong></p>
                                        <p><strong><a href="www.twitter.com">@Banco_Multinacional</a></strong><a href="www.twitter.com"></a></p>        </td>
                                </tr>
                                <tr>

<%-- 
    Document   : adduser
    Created on : Jun 5, 2012, 4:07:45 PM
    Author     : ROLANDO
--%>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td rowspan="3" align="center" valign="top"><p>      
                        <h3>&nbsp;</h3>
                        <h2><strong> </strong><img src="../images/admin.png" width="388" height="213" /></h2></td>
                    ...
                    <td rowspan="3" align="center" valign="top">
                        <form id="form1" name="form1" method="post" action="#">
                            ...
                            <p>APELLIDOS: 
                                <input name="apellidos" type="text" id="apellidos" size="42" />
                            </p>
                            <p>ÁREA: 
                                <label for="select"></label>
                                <select name="select" id="areas">
                                    <option selected="selected">Manejo de Fondos</option>
                                    <option>Monetaria</option>
                                    <option>Política</option>
                                    <option>Sistemas Financieros</option>
                                </select>
                            </p>
                            <p>NOMBRE DE USUARIO: 
                            ...
                            <p>CONTRASEÑA: 
                                <input name="pass" type="text" id="pass" size="20" />
                            </p>
                            <p>¿ES ADMINISTRADOR? 
                                <input name="esAdmin" type="radio" id="esAdminSi"  />Si
                                <input name="esAdmin" type="radio" id="esAdminNo"  checked="checked" />No
                            </p>
                            <input type="submit" value="Registrar" name="registrarB" />
                        </form>
                        ...
                        <%
                            ...
                            String esAdminSi = request.getParameter("esAdmin");
                            String combo = request.getParameter("select");
                            String admin = null;
                            String dep = null;
                            String result = null;

                            System.out.println(usr + " | " + pass + " | " + nombre + " | " + apellidos + " | " + esAdminSi + " | " + combo + " | ");

                            if (usr != null && pass != null && nombre != null && apellidos != null) {

                                if (combo.equalsIgnoreCase("Manejo de Fondos")) {
                                    dep = "1";
                                } else if (combo.equalsIgnoreCase("Monetaria")) {
                                    dep = "2";
                                } else if (combo.equalsIgnoreCase("Política")) {
                                    dep = "3";
                                } else {
                                    dep = "4";
                                }

                                if (esAdminSi.equalsIgnoreCase("on")) {
                                    admin = "1";
                                } else {
                                    admin = "0";
                                }
                                ...
                                try {
                                    ...
                                    result = port.agregaUsuario((nombre + " " + apellidos), usr, pass, admin, dep);
                                ...
                                if (result.equalsIgnoreCase("1")) {
                                    ...
                                    response.sendRedirect("adduserbad.jsp");

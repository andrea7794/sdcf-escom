 ...
 * @author PRETXEL
 */
@WebServlet(asyncSupported = false, name = "Nuevo", urlPatterns = {"/Nuevo"})
public class Nuevo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (a != null && b != null) {
                ...
                if (result.equals("1")) {
                    out.println("<html xmlns=" + "\"http://www.w3.org/1999/xhtml\"" + ">"
                            ...
                            + "<h2>Departamento: "+name_depto+"</h2>"
                            + "<form name=\"aut\" method=\"post\" action=\"#\"><table border=\"0\"><thead></thead>"
                            + "<tbody><tr><td><input name=\"consulta\" type=\"radio\" id=\"consulta\" value=\"consulta\" />Consultar Información</td>"
                            + "</tr><tr><td><input name=\"consulta\" type=\"radio\" id=\"procesa\" value=\"procesa\" />Procesar Información</td></tr><tr>"
                            + "<input type='hidden' name='depto' value='"+c+"'> "
                            + "<td><input type=\"submit\" value=\"Acceder\" name=\"accederButton\"></td></tr></tbody></table></form></td>"
            ...
            dep = request.getParameter("depto");
            
            if (e.equals("consulta")) {

                 response.sendRedirect("Consulta?dep="+dep);
                 
          
           
            } else {
                
                response.sendRedirect("Procesa?dep="+dep);
            }
    ...
    private static String verificaUsr(java.lang.String usr, java.lang.String pass, java.lang.String dep) {
        ...
        return port.verificaUsr(usr, pass, dep);
    }

    private static String procesaInformacion(java.lang.String dep) {
        escom.tds.servidor.Prevencion_Service service = new escom.tds.servidor.Prevencion_Service();
        escom.tds.servidor.Prevencion port = service.getPrevencionPort();
